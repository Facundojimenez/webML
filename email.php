...
try {
    ...
    $mail->Username   = 'facu.jimenez.cavs@gmail.com';                     //SMTP username
    $mail->Password   = 'Facu2000';                         //SMTP password
    $mail->SMTPSecure = 'tls';         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients
    $mail->setFrom('facu.jimenez.cavs@gmail.com', 'Facundo'); // Hacer coincidir con el username. (preferentemente)
